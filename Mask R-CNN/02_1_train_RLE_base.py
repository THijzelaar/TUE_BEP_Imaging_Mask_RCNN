...
#sys.path.append('./detectron2/detectron2_scripts')
from new_utilities import MyDatasetMapper, CocoAnnotationProcessor
...
annotation_path = "/home/bme001/20203080/RCNN/H-stain new/til_melanoma.json"
output_dir = "/home/bme001/20203080/RCNN/H-stain new/"
...
def setup_cfg():
    ...
    cfg.DATALOADER.NUM_WORKERS = 2 # was 4
    cfg.MODEL.WEIGHTS = model_zoo.get_checkpoint_url(wandb.config.model)
    cfg.SOLVER.IMS_PER_BATCH = 6 
    cfg.TEST.EVAL_PERIOD = 100
    cfg.TEST.DETECTIONS_PER_IMAGE = 1000
    cfg.SOLVER.BASE_LR = 0.001
    cfg.SOLVER.MAX_ITER = 3000 # was 5000
    cfg.SOLVER.STEPS = []
    cfg.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 512
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = 3
    cfg.DATALOADER.MASK_FORMAT = "rle"  # or "polygon" if you're using polygon encoding
    cfg.INPUT.MASK_FORMAT = ("bitmask")
    cfg.OUTPUT_DIR = f"./Output/{wandb.run.name}{wandb.config.cross_val}"
    
    # Changes for 4-channels
    cfg.INPUT.FORMAT = 'RGBA'
    # Reverse pixel_mean order, as standard input is BGR
    pixel_mean = cfg.MODEL.PIXEL_MEAN
    pixel_mean.reverse()
    # Add mean for 4th channel
    cfg.MODEL.PIXEL_MEAN = pixel_mean+[40.416] #average for H-stain: 181.149, dmap: 40.416
    cfg.MODEL.PIXEL_STD = [1.,]*4
    # Unfreeze backbone (normally set to 2)
    cfg.MODEL.BACKBONE.FREEZE_AT = 0 # Unfreezes the stem and first layer
    return cfg
